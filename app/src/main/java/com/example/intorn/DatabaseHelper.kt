...
class DatabaseHelper(private val context: Context) :
    ...
    fun getTotalList(): List<ReportModel> {
        ...
        val customerCount = cursor.count
        val productCount = db.rawQuery("SELECT * FROM selling_process WHERE Quantity", null).count
        val amount = db.rawQuery("SELECT * FROM selling_process WHERE Amount", null)
