...
import com.example.intorn.SellingProcessDtoModel
...
class SellingProcessAdapter(private var sellingItems: List<SellingProcessDtoModel>) :
    ...
    private var onClickListener: ((Int, SellingProcessDtoModel) -> Unit)? = null
    ...
    fun setOnClickListener(listener: (Int, SellingProcessDtoModel) -> Unit) {
    ...
    inner class SellingViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
