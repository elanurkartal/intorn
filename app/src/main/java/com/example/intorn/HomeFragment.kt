...
class HomeFragment : Fragment() {
    ...
    private fun removeProduct(){
        sellingProcessAdapter.setOnClickListener(object :SellingProcessAdapter.OnClickListener{
            override fun onClick(position: Int, model: SellingProcessDtoModel) {
                Log.v("dsasdsadf","asdfasdasdf")
            }
        })
    }
