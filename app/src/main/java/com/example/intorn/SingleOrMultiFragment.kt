...
class SingleOrMultiFragment : Fragment() {
    ...
    private fun addTotalRvSingle(view: View){
        newList = ArrayList()
    ...
    private fun addRvSingle(type: String){
        newList.add(databaseHelper.getTotalListFromPaymentType(type, databaseHelper.getUserIdFromUserName(loginUser)))
